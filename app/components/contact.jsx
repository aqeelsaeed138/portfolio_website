...
const contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "c6c651a4-7421-4ec6-b2db-82521a0f0a4e");
  ...
  return (
    <div id='contact' className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")]
     bg-no-repeat bg-center bg-[length:90%_auto]'>
      <h4 className='text-center mb-2 mt-6 text-lg'>Connect with me</h4>
      ...
      <form onSubmit={onSubmit} className='max-w-2xl mx-auto'>
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mt-10 mb-8'>
